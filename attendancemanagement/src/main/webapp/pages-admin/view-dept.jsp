...
<body class="hold-transition skin-blue layout-top-nav">
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse pull-left" id="navbar-collapse">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="#" onclick="departmentview()">Departments</a></li>
	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<h1>
				View Department Details By <small>Department</small>
			</h1>
			<ol class="breadcrumb">
		...
		<section class="content">
			<div class="box box-default">
				...
				<div class="box-body">
					<div class="row">
						<c:forEach var="viewdepartment"
							items="${sessionScope.viewdepartment }">
							<div class="col-md-6">
								<h4>
									<c:out value="${viewdepartment.department_name }">
									</c:out>
								</h4>
								<br>
							</div>
					...
					<div class="box-footer">
						...
						information about the attendance.
					</div>
				</div>
			</div>
		</section>
