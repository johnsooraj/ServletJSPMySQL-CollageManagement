						...
						<ul class="nav navbar-nav">
							...
							<li class="active dropdown"><a href="#"
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li class="active"><a href="#" onclick="addstaff()">Staffs</a></li>
		...
		<div class="content-wrapper">
			<div class="container">
				...
				<section class="content-header">
					<h1>
						Staff Registration <small>College Management</small>
					</h1>
					<ol class="breadcrumb">
					...
					<div class="col-md-12">
						<div class="box box-primary">
							...
							<form class="form-horizontal" action="attendance" method="post">
								<input type="hidden" value="staffregistration" name="hidden">
								<fieldset>
									<!-- Form Name -->
									<div class="form-group">
									...
									<!-- Select Basic -->
									<div class="form-group">
										<label class="col-md-4 control-label" for="blood_group">Designation</label>
										<div class="col-md-4">
											<select id="blood_group" name="designation"
												class="form-control">
