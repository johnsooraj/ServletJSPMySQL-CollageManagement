...
<body class="hold-transition skin-blue layout-top-nav">
						...
						<ul class="nav navbar-nav">
							...
							<li class="active dropdown"><a href="#"
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li class="active"><a href="#" onclick="adddepartment()">Departments</a></li>
		...
		<div class="content-wrapper">
			<div class="container">
				...
				<section class="content-header">
					<h1>
						Department Registration <small>College Management</small>
					</h1>
				</section>
					...
					<div class="col-md-12">
						<div class="box box-primary">
							...
							<form class="form-horizontal" action="attendance" method="post">
								<input type="hidden" name="hidden" value="registerdepartment">
								<fieldset>
									<!-- Form Name -->
									<div class="form-group">
										<label class="col-md-4 control-label" for="name">Department
											Name</label>
										<div class="col-md-4">
											<input id="departmentname" onkeyup="validate(this.value)"
	...
	<script type="text/javascript">
		...
		function validate(deptValue) {
			if (document.getElementById("departmentname").value != null) {
				...
				xhttp.onreadystatechange = function() {
					if (this.readyState == 4 && this.status == 200) {
						...
						if (this.responseText == "true") {
							...
							alert("alrady registered");
						}
					}
				};
				xhttp.open("GET",
						"attendance?hidden=liveajaxresponse&departmentnameletter="
								+ deptValue
								+ "&liveajaxdepartmentid=liveajaxdepartmentid",
						true);
				xhttp.send();
			} else {
				alert('else');
